 ...
 navigationType:(UIWebViewNavigationType)navigationType {
    ...
    if ([[url absoluteString] hasPrefix:kRedirectURL])
    {
        if ([[url.resourceSpecifier substringToIndex:8] isEqualToString:@"//cancel"]) {
            NSString * errorCode = [KaixinDialog getStringFromUrl:[url absoluteString] needle:@"error_code="];
            NSString * errorStr = [KaixinDialog getStringFromUrl:[url absoluteString] needle:@"error_msg="];
            if (errorCode) {
