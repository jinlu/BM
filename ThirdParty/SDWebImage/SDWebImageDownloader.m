...
- (void)connection:(NSURLConnection *)aConnection didReceiveData:(NSData *)data
{
    ...
    if ([delegate respondsToSelector:@selector(imageDownloader:didRecieveImageData:)])
    {
        [delegate performSelector:@selector(imageDownloader:didRecieveImageData:) withObject:self withObject:[NSNumber numberWithInt:[imageData length]]];
    }
}
